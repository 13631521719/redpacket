...
public class RedisCore {
    ...
    public static RedisCore getInstance() {
        ...
        if (instance == null) {
            synchronized (RedisCore.class) {
                if (instance == null) {
                    instance = new RedisCore();
                    if (redisTemplate == null) {
                        redisTemplate = SpringBeanUtils.getBean("redisTemplate", RedisTemplate.class);
                    }
                }
            }
        }
     ...
     * @return
     */
    public List<Long> multiGetLong(Collection<String> keys) {
        return redisTemplate.opsForValue().multiGet(keys);
    }
     ...
     * @return
     */
    public List<Object> lRangeWithObj(String key, long start, long end) {
        return redisTemplate.opsForList().range(key, start, end);
    }
     ...
     * 删除集合中值index值
     */
    public Long lRemoveObj(String key, long index, Object value) {
        return redisTemplate.opsForList().remove(key, index, value);
    }
